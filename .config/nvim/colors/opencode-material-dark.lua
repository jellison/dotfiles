...
-- Selectable via `:colorscheme opencode-material-dark` or the `<leader>uC` picker.
...
vim.g.colors_name = "opencode-material-dark"

-- Palette -------------------------------------------------------------------
local c = {
  bg          = "#263238", -- editor.background
  bg_dark     = "#1e272c", -- panels / floats / sidebars (surface)
  ...
  bg_pick_sel = "#3d5268", -- picker/explorer selected row (brighter, readable)
  ...
  fg          = "#eeffff", -- text
  fg_bright   = "#ffffff",
  muted       = "#546e7a", -- text.muted / comments / line numbers
  invisible   = "#3d4c54", -- invisibles / indent guides

  blue        = "#82aaff", -- accent, functions, info
  red         = "#f07178", -- errors, properties, tags
  green       = "#c3e88d", -- strings, added
  yellow      = "#ffcb6b", -- types, warnings, modified
  orange      = "#f78c6c", -- numbers, constants, booleans
  purple      = "#c792ea", -- keywords, attributes
  cyan        = "#89ddff", -- operators, punctuation

  -- diagnostic / diff background tints (computed over bg)
  err_bg      = "#443b41",
  warn_bg     = "#46483f",
  info_bg     = "#344356",
  hint_bg     = "#2d3b42",
